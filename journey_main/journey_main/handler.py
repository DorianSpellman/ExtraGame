...
### Конец
    ...
    if state == 80:
        ...
        tts = 'Наше путешествие в мир праздника, подошло к концу. — Хотите загадать ^желание^ вместе со мной?'
